...
def encrypt():
   ...
   if password == "1234":
       ...
       text2=Text(screen1, font="Rpbote 10", bg="Blue", relief=GROOVE, wrap=WORD, bd=0)
...
def decrypt():
   ...
   if password == "1234":
       ...
       text2 = Text(screen2, font="Rpbote 10", bg="Blue", relief=GROOVE, wrap=WORD, bd=0)
       text2.place(x=10, y=40, width=380, height=150)
